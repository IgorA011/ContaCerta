...
// Dados de exemplo para demonstração
    ...
    function setupEventListeners() {
        ...
        document.getElementById('export-movimentacoes-btn')?.addEventListener('click', exportMovimentacoes);
            ...
            relatoriosContent.innerHTML = `
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <button type="button" class="btn btn-success" id="export-movimentacoes-btn">
    ...
    function calcularSaldoLocal() {
        ...
        saldoElement.className = `fs-4 fw-bold ${saldo >= 0 ? 'saldo-positivo' : 'saldo-negativo'}`;
    }
    ...
    function exportFinanceiro() {
        ...
        const headers = ["Data", "Tipo", "Valor", "Cliente", "Produto", "Descrição"];
        ...
        exportToCSV([headers, ...data], "movimentacoes.csv");
    ...
    async function loadInitialData() {
        try {
            ...
            showNotification('Erro ao carregar dados do servidor. Usando dados de demonstração.', 'error');

            // Dados de demonstração
            clientes = [
                { id: 1, nome: "Cliente Exemplo", email: "cliente@exemplo.com", telefone: "(11) 99999-9999" }
            ];
            produtos = [
                { id: 1, nome: "Produto Exemplo", preco: 100.00, quantidadeEstoque: 10 }
            ];
            movimentacoes = [
                { id: 1, tipo: "ENTRADA", valor: 100.00, dataMovimentacao: new Date().toISOString(), descricao: "Venda exemplo" }
            ];
